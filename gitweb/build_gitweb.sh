...
wget --progress=dot https://github.com/git/git/archive/v1.8.5.2.tar.gz
tar -zxf v1.8.5.2.tar.gz
cd git-1.8.5.2
make GITWEB_PROJECTROOT="$1/git" \
...
cd .. && rm -rf git-1.8.5.2 v1.8.5.2.tar.gz
